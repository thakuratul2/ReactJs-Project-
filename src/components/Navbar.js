...
export default function Navbar(props) {
  ...
  <input class="form-check-input" type="checkbox" onClick={props.enableMode} role="switch" id="flexSwitchCheckDefault"/>
...
Navbar.defaultProps = {
    title: 'Set The Title',
    homeTitle: 'Set nav link',
    contactTitle: 'Set Description'
}
